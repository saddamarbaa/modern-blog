...
const technologyPosts = [
  ...
  },
  {
    ...
    excerpt: "Best practices and architectural patterns for creating React apps that can grow with your business.",
    author: "Mike Johnson",
    date: "Dec 12, 2024",
    category: "React",
  ...
  },
  {
    ...
    excerpt: "Master CSS Grid to create complex, responsive layouts with clean and maintainable code.",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-foreground mb-4">Technology</h1>
          <p className="text-xl text-muted-foreground">
            Discover the latest trends and innovations in technology that are shaping our digital future.
          </p>
        </div>
