...
const allPosts = [
	...
	},
	{
		...
		excerpt:
			'Learn advanced techniques to optimize your Node.js applications for better performance and scalability.',
		content:
	...
	},
	{
		...
		excerpt:
			'Master advanced TypeScript patterns and techniques for building maintainable large-scale applications.',
		content:
	...
	},
	{
		...
		excerpt:
			'Complete guide to CSS Grid layout with practical examples and advanced techniques for modern web design.',
		content:
			'CSS Grid revolutionized web layout design by providing a two-dimensional layout system...',
		author: 'Emma Wilson',
		date: 'Dec 12, 2024',
	...
	},
	{
		...
		content:
			'Testing is crucial for maintaining code quality and preventing regressions in JavaScript applications...',
		author: 'David Park',
		date: 'Dec 10, 2024',
				...
				<div className="mb-8">
					...
					{query && (
						<p className="text-muted-foreground">
							...
							{filteredPosts.length !== 1 ? 's' : ''} found for "{query}"
						</p>
					)}
				</div>
									...
									<div className="flex flex-col md:flex-row gap-6">
										...
										<div className="flex-1">
											...
											<Link href={`/blog/${post.slug}`}>
												<h2 className="text-xl font-semibold mb-2 hover:text-accent transition-colors">
													{post.title}
												</h2>
											</Link>
